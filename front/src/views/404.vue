<template>
    <div class="container">
        <div class="welcomeMsg" style="text-align:center;">
            ...
            <h2 style="font-size:35px;text-align:center;"><b>Error 404</b> <br/>Lo sentimos, no encontramos la página que buscas</h2>
        </div>
...
.container-1 .register h2 {
    font-size: 35px;
    font-weight: 800;
}

.container-1 .register button {
    border: 0;
    color: #ffffff;
    background-color: #51e49a;
    margin: 4% 0 10%;
    padding: 15px 19px;
    border-radius: 30px;
    font-size: 20px;
    box-shadow: 0 4px 2px rgba(81, 228, 154, 0.8);
    cursor: pointer;
    outline: none;
}

.container-1 .register a {
    font-size: 21px;
    margin-bottom: 2%;
}
.container-1 .register a:hover {
    font-size: 21px;
    margin-bottom: 2%;
    color: rgba(19, 194, 107, 0.8);
}
.container-1 .social-network {
    font-size: 18px;
    position: absolute;
    bottom: 0px;
    left: 0px;
...
.container-1 .social-network a {
    color: #ffffff;
}

.container-1 .social-network .pb {
    padding-bottom: 10px;
}
...
.container-2 .swiper-slide .text-slide {
    position: relative;
    padding-right: 111px;
    padding-left: 85px;
    text-align: end;
